...
import type { FontFamilyProps } from "@/components/Workspaces/EditorV2/Core/constants";
import {
  ...
  addOptions() {
    return {
      ...
      button: ({ editor, extension, t }) => {
        const fontFamilies =
          (extension.options?.fontFamilies as FontFamilyProps[]) || [];
