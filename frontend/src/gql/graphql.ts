...
export type CoreState = {
  ...
  stats: CoreStats;
  /** If finishedSetup is false, this will be the step the setup is on. */
...
export type ChatQuery = { __typename?: 'Query', chat: { __typename?: 'Chat', id: number, users: Array<{ __typename?: 'ChatAssociation', id: number, chatId: number, userId?: number | null, rank: string, createdAt: any, lastRead?: number | null, legacyUserId?: number | null, ranksMap: Array<string> }>, ranks: Array<{ __typename?: 'ChatRank', id: string, color?: string | null, name: string, userId: number, createdAt?: any | null, chatId: number, updatedAt?: any | null, managed: boolean, index: number, permissionsMap: Array<string> }>, invites: Array<{ __typename?: 'ChatInvite', id: string, userId: number, createdAt: any, rankId?: string | null, updatedAt: any, expiredAt?: any | null, invalidated: boolean }> } };
...
export type WorkspacesQuery = { __typename?: 'Query', workspaces: Array<{ __typename?: 'Workspace', id: number, name: string, userId: number, createdAt: any, updatedAt: any, icon?: string | null, folders: Array<{ __typename?: 'WorkspaceFolder', id: number, createdAt: any, updatedAt: any, name: string, workspaceId: number, folderId?: number | null, children: Array<{ __typename?: 'Note', id: number, createdAt: any, updatedAt: any, name: string, workspaceFolderId: number, shareLink?: string | null }> }> }> };
