...
export type ChatsQueryQuery = { __typename?: 'Query', userEmoji: Array<{ __typename?: 'ChatEmoji', id: string, userId?: number | null, chatId: number, icon?: string | null, name?: string | null, createdAt: any, updatedAt: any }>, chats: Array<{ __typename?: 'Chat', id: number, description?: string | null, type: string, background?: string | null, unread?: number | null, name: string, userId?: number | null, icon?: string | null, createdAt: any, updatedAt: any, _redisSortDate?: string | null, usersCount: number, recipient?: { __typename?: 'PartialUserBase', id: number } | null, association?: { __typename?: 'ChatAssociation', id: number, hidden?: boolean | null, chatId: number, permissions: Array<string>, userId?: number | null, rank: string, createdAt: any, lastRead?: number | null, notifications: string } | null }> };
